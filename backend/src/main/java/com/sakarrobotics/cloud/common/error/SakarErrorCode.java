...
public enum SakarErrorCode {
    ...
    REPAIR_REQUEST_NOT_FOUND(HttpStatus.NOT_FOUND),
    ...
    DUPLICATE_DEPARTMENT_NAME(HttpStatus.CONFLICT),
    ...
    UNSUPPORTED_ROBOT_MODEL_SERIAL_PREFIX(HttpStatus.UNPROCESSABLE_ENTITY),
